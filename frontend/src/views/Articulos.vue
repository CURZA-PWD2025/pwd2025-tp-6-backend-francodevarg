...
import ArticuloDeleteDialog from '../components/ArticuloDeleteDialog.vue'
...
async function confirmarEliminacion() {
  if (articuloSeleccionado.value) {
    const ok = await store.deleteArticulo(articuloSeleccionado.value.id)
    if (ok) {
